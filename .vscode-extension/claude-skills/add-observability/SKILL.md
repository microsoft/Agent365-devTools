...
description: Add Agent 365 observability to a non-DW autonomous agent project. For .NET, copies local staging files and adds project references (temporary until SDK ships). For Python/Node.js, installs SDK packages and injects init code.
allowed-tools: Bash(pip:*), Bash(pip3:*), Bash(npm:*), Bash(dotnet:*), Read, Write, Glob
---
