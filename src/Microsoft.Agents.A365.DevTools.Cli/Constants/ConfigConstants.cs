...
public static class ConfigConstants
{
    ...
    /// </summary>
    public const string ProductionDiscoverEndpointUrl = "https://test.agent365.svc.cloud.dev.microsoft/agents/v2/discoverMCPServers";
    // To:Do :// public const string ProductionDiscoverEndpointUrl = "https://agent365.svc.cloud.microsoft/agents/v2/discoverMCPServers";
